...
// Dialog Data
	...
	//}}AFX_VIRTUAL
	virtual void CAboutDlg::OnOK(); 
	virtual void CAboutDlg::OnCancel(); 
...
void CModallessDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
	if ((nID & 0xFFF0) == IDM_ABOUTBOX)
	{
		...
		pDlg->Create(IDD_ABOUTBOX); //IDD_MODALLESS_DIALOG); 
...
HCURSOR CModallessDlg::OnQueryDragIcon()
{
