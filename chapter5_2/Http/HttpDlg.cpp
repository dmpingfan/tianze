...
void CHttpDlg::OnButtonTest() 
{
	// TODO: Add your control notification handler code here
	HttpClient(); 
}

BOOL CHttpDlg::HttpClient()
{
	WSADATA ws; 
	long lResult = WSAStartup(0x0101, &ws); 
	SOCKET s = socket(AF_INET, SOCK_STREAM, 0); 
	struct sockaddr_in addr; 
	addr.sin_family = AF_INET; 
	addr.sin_port = htons(80); 
	addr.sin_addr.s_addr = inet_addr("192.168.0.1"); //inet_addr("http://www.126.com"); //inet_addr("168.160.224.185"); 
