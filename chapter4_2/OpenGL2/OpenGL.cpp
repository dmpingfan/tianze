...
BOOL COpenGLApp::InitInstance()
{
	...
	m_hMDIMenu  = ::LoadMenu(hInst, MAKEINTRESOURCE(IDR_OPENGLTYPE));
	m_hMDIAccel = ::LoadAccelerators(hInst, MAKEINTRESOURCE(IDR_OPENGLTYPE));
...
void COpenGLApp::OnFileNew() 
{
	...
	pFrame->CreateNewChild(
		RUNTIME_CLASS(CChildFrame), IDR_OPENGLTYPE, m_hMDIMenu, m_hMDIAccel);
}
