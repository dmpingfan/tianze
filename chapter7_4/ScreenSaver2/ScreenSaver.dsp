...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib scrnsave.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/ScreenSaver.scr" /pdbtype:sept
# Begin Custom Build - Copying the screen saver to windows system directory
TargetPath=.\Debug\ScreenSaver.scr
TargetName=ScreenSaver
InputPath=.\Debug\ScreenSaver.scr
SOURCE="$(InputPath)"

"$(TargetName).scr" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetPath) C:\Windows\System32\$(TargetName).scr
