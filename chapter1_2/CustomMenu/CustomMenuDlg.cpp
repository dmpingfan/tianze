// CustomMenuDlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CCustomMenuDlg message handlers
...
BOOL CCustomMenuDlg::OnInitDialog()
{
	...
	m_menu.CreateMenu(); 
    //m_menu.SetIconSize(25, 25); 
    //m_menu.SetHighlightStyle(Normal); 
	m_menu.SetHighlightStyle(TextOnly); 
    //m_menu.SetTextColor(RGB(255, 0, 0)); 
    //m_menu.SetBackColor(RGB(255, 255, 255)); 
    //m_menu.SetHighlightColor(RGB(0, 0, 255)); 

	lstrcpy(m_data.menuText, "text1"); 
	m_data.menuIconNormal = (UINT)IDI_APPLICATION; 
	m_data.menuIconSelected = (UINT)IDI_ERROR; 
	m_menu.AppendMenu(MF_OWNERDRAW, 3, (LPCTSTR)&m_data); 
	m_menu.AppendMenu(MF_OWNERDRAW, 4, (LPCTSTR)&m_data); 

	CMenu menu; 
	menu.CreateMenu(); 
	menu.AppendMenu(MF_POPUP, (UINT)m_menu.GetSafeHmenu(), "POP UP"); 
	SetMenu(&menu); 
	menu.Detach(); 
