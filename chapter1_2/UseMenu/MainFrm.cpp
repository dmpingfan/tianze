...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	pMenu->AppendMenu(MF_STRING, IDM_ABOUT, "&About"); 
...
void CMainFrame::OnSysCommand(UINT nID, LPARAM lParam) 
{
	...
	if(nID == IDM_ABOUT) //(nID & 0xFFF0) == IDM_ABOUT)
	{
		//OnCmdMsg(ID_APP_ABOUT, 0, NULL, NULL); 
		//DefWindowProc(WM_COMMAND, ID_APP_ABOUT, 0); 
		//WindowProc(WM_COMMAND, ID_APP_ABOUT, 0); 
